...
<html lang="en">
  ...
  <head>
    ...
    <title>Poonam Chand Sahu | Tech Enthusiast - Fresher - Freelancer - Web Developer </title>
  ...
  <body id="page-top">
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-primary fixed-top" id="sideNav">
      <a class="navbar-brand js-scroll-trigger" href="#page-top">
        ...
        <span class="d-none d-lg-block">
          <img class="img-fluid img-profile rounded-circle mx-auto mb-2" src="img/poonam-chand-sahu.jpg" alt="">
        </span>
      </a>
    ...
    <div class="container-fluid p-0">
      ...
      <section class="resume-section p-3 p-lg-5 d-flex d-column" id="about">
        <div class="my-auto">
          <h1 class="mb-0">Poonam Chand
            <span class="text-primary">Sahu</span>
          </h1>
          <div class="subheading mb-5">Bhilai ·
            <a href="mailto:name@email.com">poonamchandsahu.ssgi@gmail.com</a>
          </div>
        ...
        <div class="my-auto">
          ...
          <div class="resume-item d-flex flex-column flex-md-row mb-5">
            ...
            <div class="resume-date text-md-right">
              <span class="text-primary">July 2015 - Present</span>
            </div>
          </div>
      ...
      <section class="resume-section p-3 p-lg-5 d-flex flex-column" id="skills">
        <div class="my-auto">
		  ...
		  <li class="list-inline-item">
			...
			<li class="list-inline-item">
              <i class="devicons devicons-ruby-on-rails"></i>
            </li>
